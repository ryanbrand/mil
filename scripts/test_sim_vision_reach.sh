...
python main.py --experiment=sim_vision_reach --demo_file=data/sim_vision_reach_test \
                  --demo_gif_dir=data/sim_vision_reach_test/ --gif_prefix=color --im_width=80 --training_set_size=750\
                  ...
                  --num_conv_layers=3 --num_strides=3 --num_fc_layers=3 --layer_size=200 --gpu_memory_fraction=0.4\
