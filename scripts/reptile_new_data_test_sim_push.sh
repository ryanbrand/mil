...
python main_reptile_new_data.py --experiment=sim_push --demo_file=data/sim_push_test --demo_gif_dir=data/sim_push_test/ --gif_prefix=object \
                  ...
                  --random_seed=5 --train=False --resume=True --restore_iter=9000 --record_gifs=True
